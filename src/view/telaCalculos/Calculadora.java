...
public class Calculadora {
	 ...
	 * </p>
	 * <p>
	 * As operações nessa classe são delegadas para os métodos que contém as lógicas na classe {@link controller.LogicaCalculadora}.
	 * </p>
	 */
	...
	public static void calcular() {
		...
		String[] operacoes = {"Selecione uma opção", "Adição", "Subtração", "Multiplicação", "Divisão", "Resto da Divisão", "Porcentagem",
				"Potenciação", "Radiciação", "Exponencial", "Logaritmico"};
		...
		lblNum1.setPreferredSize(new Dimension(180, 30));
		JTextField num1 = new JTextField();
		num1.setPreferredSize(new Dimension(200, 30));
		...
		lblNum2.setPreferredSize(new Dimension(180, 30));
		JTextField num2 = new JTextField();
		num2.setPreferredSize(new Dimension(200, 30));
		...
		calcular.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// devo limpar todos os campos apos cada calculo
				try {
					...
					if (comboOperacao.getSelectedIndex() == 0) {
						...
						if (op.equals("Adição")) {
							double resultado = lc.somar(valor1, valor2);
							String formatado = String.format("%.4f", resultado);
							JOptionPane.showMessageDialog(frame, "<html>O resultado é: <font color='red'>" + formatado + "</font></html>",
									"Resultado", JOptionPane.INFORMATION_MESSAGE);
							num1.setText("");
							num2.setText("");
						} else if (op.equals("Subtração")) {
							double resultado = lc.subtrair(valor1, valor2);
							String formatado = String.format("%.4f", resultado);
							JOptionPane.showMessageDialog(frame, "<html>O resultado é: <font color='red'>" + formatado + "</font></html>",
									"Resultado", JOptionPane.INFORMATION_MESSAGE);
							num1.setText("");
							...
							double resultado = lc.multiplicar(valor1, valor2);
							String formatado = String.format("%.4f", resultado);
							JOptionPane.showMessageDialog(frame, "<html>O resultado é: <font color='red'>" + formatado + "</font></html>",
									"Resultado", JOptionPane.INFORMATION_MESSAGE);
							num1.setText("");
							...
							double resultado = lc.dividir(valor1, valor2);
							...
							if (valor1 == 0 || valor2 == 0) {
								...
								JOptionPane.showMessageDialog(frame,
										"<html>O resultado é: <font color='red'>" + formatado + "</font></html>", "Resultado",
							...
							double resultado = lc.restoDaDivisao(valor1, valor2);
							String formatado = String.format("%.4f", resultado);
							JOptionPane.showMessageDialog(frame, "<html>O resultado é: <font color='red'>" + formatado + "</font></html>",
									"Resultado", JOptionPane.INFORMATION_MESSAGE);
							num1.setText("");
							...
							double resultado = lc.porcentagem(valor1, valor2);
							String formatado = String.format("%.4f", resultado);
							JOptionPane.showMessageDialog(frame, "<html>O resultado é: <font color='red'>" + formatado + "</font></html>",
									"Resultado", JOptionPane.INFORMATION_MESSAGE);
							num1.setText("");
							...
							double resultado = lc.potenciacao(valor1, valor2);
							String formatado = String.format("%.4f", resultado);
							JOptionPane.showMessageDialog(frame, "<html>O resultado é: <font color='red'>" + formatado + "</font></html>",
									"Resultado", JOptionPane.INFORMATION_MESSAGE);
							num1.setText("");
							...
							double resultado = lc.radiciacao(valor1);
							String formatado = String.format("%.4f", resultado);
							JOptionPane.showMessageDialog(frame, "<html>O resultado é: <font color='red'>" + formatado + "</font></html>",
									"Resultado", JOptionPane.INFORMATION_MESSAGE);
							num1.setText("");
							...
							double resultado = lc.exponencial(valor1);
							String formatado = String.format("%.4f", resultado);
							JOptionPane.showMessageDialog(frame, "<html>O resultado é: <font color='red'>" + formatado + "</font></html>",
									"Resultado", JOptionPane.INFORMATION_MESSAGE);
							num1.setText("");
							...
							double resultado = lc.logaritmico(valor1);
							String formatado = String.format("%.4f", resultado);
							JOptionPane.showMessageDialog(frame, "<html>O resultado é: <font color='red'>" + formatado + "</font></html>",
									"Resultado", JOptionPane.INFORMATION_MESSAGE);
							num1.setText("");
					...
					JOptionPane.showMessageDialog(frame,
							"Entrada inválida! Digite apenas números e preencha os dois campos quando o cálculo o exige!", "Erro",
							JOptionPane.ERROR_MESSAGE);
				}
			}
		});
